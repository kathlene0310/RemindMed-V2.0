...
public class set_later_heart_rate extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_later_heartrate);
        ...
        ArrayAdapter<String> adapterFrequency = new ArrayAdapter<String>(set_later_heart_rate.this,
            ...
            public void onClick(View v) {
                try{
                    ...
                    if (myAlarmDate.getTimeInMillis() < System.currentTimeMillis()) {
                        Toast.makeText(set_later_heart_rate.this, "Set the time and date to the future", Toast.LENGTH_LONG).show();
                        return;
                    }
                    else
                    {
                    ...
                    fstore.collection("users").document(userId).collection("Health Measurement Alarm")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                ...
                                public void onSuccess(DocumentReference documentReference) {
                                    Toast.makeText(set_later_heart_rate.this, "New HM added", Toast.LENGTH_SHORT).show();
                                }
                            })
                    ...
                    startActivity(new Intent(set_later_heart_rate.this, home_page.class));
                }catch (Exception e)
                {
                    Toast.makeText(set_later_heart_rate.this, "Please input data in all fields", Toast.LENGTH_SHORT).show();
    ...
    public void laterpulse_To_lhm(View view) {
        Intent intent = new Intent(set_later_heart_rate.this, setLaterHM.class);
