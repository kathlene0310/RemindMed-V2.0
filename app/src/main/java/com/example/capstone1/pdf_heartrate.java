...
public class pdf_heartrate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf_heartrate);
        ...
        if(SDK_INT >= 30) {
            ...
            verifyStoragePermissions(pdf_heartrate.this);
        }
        ...
        myAdapter = new pdfAdapter(pdf_heartrate.this, myArrayList);
        ...
        savePDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Toast.makeText(pdf_heartrate.this, "No data to turn to PDF", Toast.LENGTH_SHORT).show();
...
//                holder.itemView.destroyDrawingCache();
    ...
    private void createPdf(View title, Bitmap measurements, Bitmap header){
        ...
        canvas.drawText("RemindMedV2",20,60,paint);
        paint.setTextSize(30.5f);
        canvas.drawText("Report for Heart Rate",20,90,paint);
        ...
        File file = new File(folder,"RemindMedHeartRate.pdf");
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public void pdfpulse_To_hhm(View view) {
        Intent intent = new Intent(pdf_heartrate.this, health_measurement_pdf_choices.class);
