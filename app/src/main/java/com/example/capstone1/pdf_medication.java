...
public class pdf_medication extends AppCompatActivity {
    RecyclerView recyclerView;
    ArrayList<medication_history_info> myArrayList;
    pdfAdapterMedication myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new pdfAdapterMedication(pdf_medication.this, myArrayList);
        ...
        savePDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Toast.makeText(pdf_medication.this, "No data to turn to PDF", Toast.LENGTH_SHORT).show();
    ...
    private void showTable() {
        ...
        db.document("users/" + currentFirebaseUser.getUid()).collection("Medication History")
                .orderBy("StartDate", Query.Direction.ASCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
...
//                holder.itemView.destroyDrawingCache();
    ...
    private void createPdf(View title, Bitmap measurements, Bitmap header){
        ...
        canvas.drawText("RemindMed V2",20,60,paint);
        paint.setTextSize(30.5f);
        canvas.drawText("Report for Medications",20,90,paint);
